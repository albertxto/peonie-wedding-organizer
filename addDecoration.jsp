...
<body>	
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Insert New Decoration</h1>
				<form action="controller/doAddDecoration.jsp" method="post" class="form-horizontal" enctype="multipart/form-data">
